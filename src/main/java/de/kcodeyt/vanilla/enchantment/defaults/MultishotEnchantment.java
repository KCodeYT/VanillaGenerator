 ...
 */
public class MultishotEnchantment extends VanillaEnchantment {

    public MultishotEnchantment(EnchantmentRarity rarity) {
        super(rarity, EnchantmentType.CROSSBOW);
    }
    ...
    public boolean canApplyTogether(VanillaEnchantment enchantment) {
        return super.canApplyTogether(enchantment) && !(enchantment instanceof PiercingEnchantment);
    }
