 ...
 */
public class RiptideEnchantment extends VanillaEnchantment {

    public RiptideEnchantment(EnchantmentRarity rarity) {
    ...
    public boolean canApplyTogether(VanillaEnchantment enchantment) {
        return super.canApplyTogether(enchantment) && !(enchantment instanceof LoyaltyEnchantment) && !(enchantment instanceof ChannelingEnchantment);
    }
