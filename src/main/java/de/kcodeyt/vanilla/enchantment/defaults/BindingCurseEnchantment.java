 ...
 */
public class BindingCurseEnchantment extends VanillaEnchantment {

    public BindingCurseEnchantment(EnchantmentRarity rarity) {
        super(rarity, EnchantmentType.WEARABLE);
    }
