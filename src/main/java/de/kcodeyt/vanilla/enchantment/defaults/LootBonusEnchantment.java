 ...
 */
public class LootBonusEnchantment extends VanillaEnchantment {

    public LootBonusEnchantment(EnchantmentRarity rarity, EnchantmentType type) {
        super(rarity, type);
    }
    ...
    public boolean canApplyTogether(VanillaEnchantment enchantment) {
        return super.canApplyTogether(enchantment) && !(enchantment instanceof SilkTouchEnchantment);
    }
}
