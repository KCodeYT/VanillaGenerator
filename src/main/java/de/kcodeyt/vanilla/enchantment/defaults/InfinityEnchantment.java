 ...
 */
public class InfinityEnchantment extends VanillaEnchantment {

    public InfinityEnchantment(EnchantmentRarity rarity) {
        super(rarity, EnchantmentType.BOW);
    }
    ...
    public boolean canApplyTogether(VanillaEnchantment enchantment) {
        return !(enchantment instanceof MendingEnchantment) && super.canApplyTogether(enchantment);
    }
}
