 ...
 */
public class VanishingCurseEnchantment extends VanillaEnchantment {

    public VanishingCurseEnchantment(EnchantmentRarity rarity) {
        super(rarity, EnchantmentType.VANISH);
    }
