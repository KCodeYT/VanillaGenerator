 ...
 */
public class SwiftSneakEnchantment extends VanillaEnchantment {

    public SwiftSneakEnchantment(EnchantmentRarity rarity) {
        super(rarity, EnchantmentType.ARMOR_LEGGINGS);
    }
