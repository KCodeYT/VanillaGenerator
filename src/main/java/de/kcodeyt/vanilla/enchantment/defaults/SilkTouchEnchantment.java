 ...
 */
public class SilkTouchEnchantment extends VanillaEnchantment {

    public SilkTouchEnchantment(EnchantmentRarity rarity) {
    ...
    public boolean canApplyTogether(VanillaEnchantment enchantment) {
        return super.canApplyTogether(enchantment) && !(enchantment instanceof LootBonusEnchantment && enchantment.getType() == this.getType());
    }
