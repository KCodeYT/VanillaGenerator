 ...
 */
public class FrostWalkerEnchantment extends VanillaEnchantment {

    public FrostWalkerEnchantment(EnchantmentRarity rarity) {
    ...
    public boolean canApplyTogether(VanillaEnchantment enchantment) {
        return super.canApplyTogether(enchantment) && !(enchantment instanceof DepthStriderEnchantment);
    }
