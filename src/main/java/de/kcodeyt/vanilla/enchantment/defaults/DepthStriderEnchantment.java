 ...
 */
public class DepthStriderEnchantment extends VanillaEnchantment {

    public DepthStriderEnchantment(EnchantmentRarity rarity) {
    ...
    public boolean canApplyTogether(VanillaEnchantment enchantment) {
        return super.canApplyTogether(enchantment) && !(enchantment instanceof FrostWalkerEnchantment);
    }
