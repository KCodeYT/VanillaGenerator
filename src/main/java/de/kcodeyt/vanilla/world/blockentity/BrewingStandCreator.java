 ...
 */
public class BrewingStandCreator implements BlockEntityCreator {
    ...
    public void createBlockEntity(VanillaServer generator, FullChunk fullChunk, CompoundTag baseTag) {
        ...
        final short fuelTotal = (short) (baseTag.containsShort("FuelTotal") ? baseTag.getShort("FuelTotal") : 0);
        final short fuelAmount = (short) (baseTag.containsShort("FuelAmount") ? baseTag.getShort("FuelAmount") : 0);
        ...
        BlockEntity.createBlockEntity(BlockEntity.BREWING_STAND, fullChunk,
                this.createBaseBlockEntityTag(baseTag)
                        .putShort("CookTime", cookTime)
                        .putShort("FuelTotal", fuelTotal)
                        .putShort("FuelAmount", fuelAmount)
                        .putList(itemsTag)
        );
    }
